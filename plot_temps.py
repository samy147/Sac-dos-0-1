...
df = pd.read_csv(csv_file_path, header=None, names=['Taille', 'BT1', 'BT2', 'DP', 'DPV', 'DPM', 'DPG'])
...
plt.plot(df['Taille'], df['DPV'], label='Programmation Dynamique Valeur', marker='D')
plt.plot(df['Taille'], df['DPM'], label='Programmation Dynamique avec capacité minimale', marker='.')
plt.plot(df['Taille'], df['DPG'], label='Algorithme glouton', marker='*')
